...
public class ListFieldEditor extends ListEditor implements DbfPluginResources {
	...
	protected String createList(String[] items) {
		...
		for (int i = 0; i < items.length; i++) {
			...
			path.append(DbfPluginResources.PREF_PAGE_LIST_SEPARATOR);
		}
	...
	protected String getNewInputObject() {
		...
		InputDialog dialog = new InputDialog(getShell(),
				"New Dbf JVM paramater", "Enter a JVM parameter", defaultValue,
				null);
		String param = null;
	...
	protected String[] parseString(String stringList) {
		StringTokenizer st = new StringTokenizer(stringList,
				DbfPluginResources.PREF_PAGE_LIST_SEPARATOR); //$NON-NLS-1$
