...
/**
 * Use in DbfPreferencePage This class is based on PathEditor There is a button
 * to add files on the list,
 */
 ...
 */
public class ClasspathFieldEditor extends ListFieldEditor implements
		DbfPluginResources {
	...
	protected void createButtons(Composite buttonBox) {
		addJarZipButton = createPushButton(buttonBox,
				PREF_PAGE_ADDJARZIPBUTTON_LABEL);//$NON-NLS-1$
