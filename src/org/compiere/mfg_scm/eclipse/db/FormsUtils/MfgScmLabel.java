...
public class MfgScmLabel extends Composite implements DBFfield {
	...
	public MfgScmLabel(Composite parent, int style) {
		super(parent, style);
		initialize();
	}
	...
	private void initialize() {
		...
		label.setBounds(new org.eclipse.swt.graphics.Rectangle(0, 0, 96, 20));
		label.setText("Label");
