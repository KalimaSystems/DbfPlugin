...
public class MfgScmCheckBox extends Composite implements DBFfield {
	...
	public MfgScmCheckBox(Composite parent, int style) {
		super(parent, style);
		initialize();
	}
	...
	private void initialize() {
		...
		checkBox
				.setBounds(new org.eclipse.swt.graphics.Rectangle(0, 0, 80, 21));
	...
	public void setTextAlignment(int textAlignment) {
		checkBox.setAlignment(textAlignment);
	}

	public int getTextAlignment() {
		return checkBox.getAlignment();
	}
